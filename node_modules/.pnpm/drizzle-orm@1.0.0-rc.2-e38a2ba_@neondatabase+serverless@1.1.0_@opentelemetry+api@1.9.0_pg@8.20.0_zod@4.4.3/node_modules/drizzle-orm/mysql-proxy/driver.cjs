...
function drizzle(callback, config = {}, _dialect = () => new __mysql_core_dialect_ts.MySqlDialect()) {
	...
	return new MySqlRemoteDatabase(dialect, new require_mysql_proxy_session.MySqlRemoteSession(callback, dialect, relations, schema, {
		logger,
