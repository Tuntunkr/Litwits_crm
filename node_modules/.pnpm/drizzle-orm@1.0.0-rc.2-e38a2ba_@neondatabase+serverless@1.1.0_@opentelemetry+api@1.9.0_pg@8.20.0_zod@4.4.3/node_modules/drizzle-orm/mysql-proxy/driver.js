...
function drizzle(callback, config = {}, _dialect = () => new MySqlDialect()) {
	...
	return new MySqlRemoteDatabase(dialect, new MySqlRemoteSession(callback, dialect, relations, schema, {
		logger,
