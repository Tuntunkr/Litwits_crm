...
var TiDBServerlessPreparedQuery = class extends __mysql_core_session_ts.MySqlPreparedQuery {
	...
	async executeRqbV2(placeholderValues = {}) {
		...
		const { rows } = await client.execute(queryString, params, executeRawConfig);
...
var TiDBServerlessSession = class TiDBServerlessSession extends __mysql_core_session_ts.MySqlSession {
	...
	prepareQuery(query, fields, customResultMapper, generatedIds, returningIds, queryMetadata, cacheConfig) {
		return new TiDBServerlessPreparedQuery(this.client, query.sql, query.params, this.logger, this.cache, queryMetadata, cacheConfig, fields, this.options.useJitMappers, customResultMapper, generatedIds, returningIds);
	}
	prepareRelationalQuery(query, fields, customResultMapper, config, generatedIds, returningIds) {
		return new TiDBServerlessPreparedQuery(this.client, query.sql, query.params, this.logger, this.cache, void 0, void 0, fields, this.options.useJitMappers, customResultMapper, generatedIds, returningIds, true, config);
	}
	all(query) {
